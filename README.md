...
Execute commands in `deactivate_env.sh` in the terminal or run
```bash
...
│   ├── <b>BASELINE_agent.py:</b> (BASELINE agents)
│   ├── <b>BASELINE_eval_agent.py:</b> (BASELINE evaluation)
│   ├── <b>BASELINE_train.py:</b> (BASELINE evaluation)
│   ├── <b>phyplan.py:</b> (Our Planner or reasoning agent)
